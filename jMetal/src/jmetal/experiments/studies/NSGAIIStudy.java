...
public class NSGAIIStudy extends Experiment {
  ...
  public static void main(String[] args) throws JMException, IOException {
    ...
    exp.indicatorList_   = new String[]{ "SPREAD", "IGD", "EPSILON"} ;
    
    int numberOfAlgorithms = exp.algorithmNameList_.length ;

    exp.experimentBaseDirectory_ = "E:\\02_Weili\\test\\results" +
                                   exp.experimentName_;
    exp.paretoFrontDirectory_ = "E:\\02_Weili\\test\\paretoFronts";
